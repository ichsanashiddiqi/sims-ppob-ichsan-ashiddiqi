...
<body>
    ...
    function previewImg() {
        ...
        if (foto_profil.files && foto_profil.files[0]) {
            // ambil file yg diupload (di tag input wajib set id='foto_profil')
            const fileImage = new FileReader();
            fileImage.readAsDataURL(foto_profil.files[0]);
            // alert file from input with id="foto_profil" alert image uploaded if has file
            // alert(foto_profil.files[0]);
            // ganti preview-nya
    ...
    <!-- submit img update -->
    <script>
    var submitLink = document.getElementById('submitUpdateImgProfile');
    var form = document.getElementById('formUpdateImgProfile');
